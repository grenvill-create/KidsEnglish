...
export const WORD_DICTIONARY = {
  ...
  'alive': {
    word: 'alive',
    displayWord: 'alive (活着的，有生气的)',
    phonetic: '/əˈlaɪv/',
    pos: 'adj. 形容词',
    cn: '活着的，生机勃勃的；天哪 (口语)',
    en: 'Living, not dead; full of life and energy.',
    emoji: '🐍',
    exampleEn: 'Snakes Alive! What a surprise!',
    exampleCn: '天哪！真让人惊喜！（Snakes Alive 是英语经典感叹习语）',
    tip: '💡 习语扩展："Snakes Alive!" 就像中文里的“天哪！我的老天爷！”表示极大惊讶与兴奋！'
  },
  'naming': {
    word: 'naming',
    displayWord: 'naming (命名，说出名称)',
    phonetic: '/ˈneɪmɪŋ/',
    pos: 'n. / adj.',
    cn: '命名，命名的；主语部分 (Naming part)',
    en: 'The act of giving a name; naming part tells who or what the sentence is about.',
    emoji: '🏷️',
    exampleEn: 'A sentence has a naming part.',
    exampleCn: '一个句子包含命名部分（即主语，说明谁或什么）。',
    tip: '💡 语法核心：Naming part (主语部分) 回答 "Who?" (谁) 或 "What?" (什么东西)！'
  },
  'ringing': {
    word: 'ringing',
    displayWord: 'ringing (响铃，鸣响)',
    phonetic: '/ˈrɪŋɪŋ/',
    pos: 'v. 动词现在分词',
    cn: '（铃声、电话）响个不停',
    en: 'Making a clear sound like a bell or a phone.',
    emoji: '📞',
    exampleEn: 'The phone is ringing.',
    exampleCn: '电话正在响铃。',
    tip: '💡 动词原形为 ring (ring, rang, rung)。'
  },
  'coach': {
    word: 'coach',
    displayWord: 'coach (教练)',
    phonetic: '/koʊtʃ/',
    pos: 'n. 名词',
    cn: '（体育运动的）教练，指导老师',
    en: 'A person who trains athletes or sports teams.',
    emoji: '⚽',
    exampleEn: 'My dad is the coach.',
    exampleCn: '我爸爸是球队教练。',
    tip: '💡 字母组合 oa 发长双元音 /oʊ/。'
  },
  'hamster': {
    word: 'hamster',
    displayWord: 'hamster (仓鼠)',
    phonetic: '/ˈhæmstər/',
    pos: 'n. 名词',
    cn: '仓鼠，地鼠',
    en: 'A small furry rodent with large cheek pouches.',
    emoji: '🐹',
    exampleEn: "Jon's hamster ran away.",
    exampleCn: '乔恩的小仓鼠跑掉了。',
    tip: '💡 仓鼠两颊有大大的储食袋 (cheek pouches)，喜欢把食物藏在腮帮子里！'
  },
  'ran': {
    word: 'ran',
    displayWord: 'ran (跑，run的过去式)',
    phonetic: '/ræn/',
    pos: 'v. 动词过去式',
    cn: '跑，奔跑 (run 的过去式)',
    en: 'Past tense of run; moved swiftly on foot.',
    emoji: '🏃',
    exampleEn: 'The hamster ran away quickly.',
    exampleCn: '小仓鼠迅速跑掉了。',
    tip: '💡 不规则动词变化：run (现在) -> ran (过去) -> run (分词)。'
  },
  'away': {
    word: 'away',
    displayWord: 'away (离开，朝远处)',
    phonetic: '/əˈweɪ/',
    pos: 'adv. 副词',
    cn: '向远处，离开',
    en: 'To or at a distance from a particular place.',
    emoji: '💨',
    exampleEn: 'The puppy ran away into the garden.',
    exampleCn: '小狗跑远进了花园。',
    tip: '💡 常用搭配：run away (逃跑，跑走)。'
  },
  'bus': {
    word: 'bus',
    displayWord: 'bus (公共汽车，校车)',
    phonetic: '/bʌs/',
    pos: 'n. 名词 (复数: buses)',
    cn: '公共汽车，大巴车，校车',
    en: 'A large motor vehicle carrying passengers by road.',
    emoji: '🚌',
    exampleEn: 'Our bus was late this morning.',
    exampleCn: '今天早上我们的校车迟到了。',
    tip: '💡 school bus = 黄色校车。'
  },
  'late': {
    word: 'late',
    displayWord: 'late (迟到的，晚的)',
    phonetic: '/leɪt/',
    pos: 'adj. 形容词 / adv. 副词',
    cn: '迟到的，晚的，推迟的',
    en: 'Arriving or taking place after the expected or usual time.',
    emoji: '⏰',
    exampleEn: 'Do not be late for school!',
    exampleCn: '上学不要迟到哦！',
    tip: '💡 反义词：late (晚的) ↔ early (早的)。'
  },
  'teacher': {
    word: 'teacher',
    displayWord: 'teacher (老师，教师)',
    phonetic: '/ˈtiːtʃər/',
    pos: 'n. 名词',
    cn: '老师，教师',
    en: 'A person who teaches, especially in a school.',
    emoji: '👨‍🏫',
    exampleEn: 'The teacher left his home with a smile.',
    exampleCn: '老师微笑着离开家去学校。',
    tip: '💡 词根巧记：teach (教导) + er (人) = 教学的人即老师！'
  },
  'left': {
    word: 'left',
    displayWord: 'left (离开，leave的过去式)',
    phonetic: '/left/',
    pos: 'v. 动词过去式 / adj. 左边的',
    cn: '离开 (leave 的过去式)；左边',
    en: 'Past tense of leave; went away from a place.',
    emoji: '🚪',
    exampleEn: 'He left his home at eight o\'clock.',
    exampleCn: '他八点钟离开了家。',
    tip: '💡 一词多义：left 可以表示“左边”，也可以是 leave (离开) 的过去式！'
  },
  'home': {
    word: 'home',
    displayWord: 'home (家，家庭)',
    phonetic: '/hoʊm/',
    pos: 'n. 名词 / adv. 副词',
    cn: '家，住所，家园',
    en: 'The place where one lives permanently.',
    emoji: '🏡',
    exampleEn: 'Welcome to my sweet home.',
    exampleCn: '欢迎来到我温馨的家。',
    tip: '💡 go home = 回家（前面不加 to）。'
  },
  'visit': {
    word: 'visit',
    displayWord: 'visit (拜访，看望)',
    phonetic: '/ˈvɪzɪt/',
    pos: 'v. 动词 / n. 名词',
    cn: '拜访，看望，做客',
    en: 'To go to see someone or a place.',
    emoji: '👋',
    exampleEn: 'Greg and Pete visit us on weekends.',
    exampleCn: '格雷格和皮特周末来拜访我们。',
    tip: '💡 visitor = 访客，客人。'
  },
  'part': {
    word: 'part',
    displayWord: 'part (部分，局部)',
    phonetic: '/pɑːrt/',
    pos: 'n. 名词',
    cn: '部分，部件',
    en: 'A piece or segment of something such as a sentence.',
    emoji: '🧩',
    exampleEn: 'The naming part tells who or what.',
    exampleCn: '命名部分告诉我们是谁或者什么。',
    tip: '💡 parts of a sentence = 句子的组成部分。'
  }
}

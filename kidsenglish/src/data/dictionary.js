...
export const WORD_DICTIONARY = {
  // === 0. 星期二：Going to Grammy's 复合词与行李清单核心词汇 (Scholastic Reading for details) ===
  'compound': {
    word: 'compound',
    displayWord: 'compound (复合的)',
    phonetic: '/ˈkɒmpaʊnd/',
    pos: 'adj. 形容词 / n. 名词',
    cn: '复合的，合成的；混合物',
    en: 'Made up of two or more existing parts or elements.',
    emoji: '🧩',
    exampleEn: 'A compound word is a big word made up of two little words.',
    exampleCn: '复合词是由两个小单词组合而成的大单词。',
    tip: '💡 比如：cow (奶牛) + boy (男孩) = cowboy (牛仔)！'
  },
  'compoundword': {
    word: 'compound word',
    displayWord: 'compound word (复合词)',
    phonetic: '/ˈkɒmpaʊnd wɜːrd/',
    pos: 'n. 名词短语',
    cn: '复合词，合成词',
    en: 'A word made of two or more words joined together, such as sun + glasses = sunglasses.',
    emoji: '🧩',
    exampleEn: 'Find 8 compound words in this story.',
    exampleCn: '在这个故事中找出8个复合词。',
    tip: '💡 复合词拆分秘诀：找到两个都能独立存在的单词组合起来就是它！'
  },
  'grandmother': {
    word: 'grandmother',
    displayWord: 'grandmother (祖母/外婆)',
    phonetic: '/ˈɡrænmʌðər/',
    pos: 'n. 名词 (grand + mother)',
    cn: '祖母，外婆，奶奶，姥姥',
    en: 'The mother of your father or mother. A compound word: grand + mother.',
    emoji: '👵',
    exampleEn: 'Kelly is going to spend the night with her grandmother.',
    exampleCn: '凯莉打算去外婆（奶奶）家过夜。',
    tip: '💡 复合词拆解：grand (宏大的/尊贵的) + mother (母亲) = grandmother (祖母/外婆)！'
  },
  'grammy': {
    word: 'grammy',
    displayWord: 'Grammy / grammy (奶奶/外婆)',
    phonetic: '/ˈɡræmi/',
    pos: 'n. 名词 (口语昵称)',
    cn: '奶奶，外婆 (亲昵称呼)',
    en: 'An informal and loving word for grandmother.',
    emoji: '👵',
    exampleEn: 'Grammy told her to bring a swimsuit.',
    exampleCn: '奶奶告诉她带一件泳衣。',
    tip: '💡 英语家庭里孩子常亲切称呼祖母为 Grammy, Granny, Grandma 或 Nana。'
  },
  'suitcase': {
    word: 'suitcase',
    displayWord: 'suitcase (旅行手提箱)',
    phonetic: '/ˈsuːtkeɪs/',
    pos: 'n. 名词 (suit + case)',
    cn: '手提箱，衣箱，行李箱',
    en: 'A case with a handle for carrying clothes and personal items when traveling. (suit + case)',
    emoji: '🧳',
    exampleEn: 'Into the suitcase go her toothbrush, toothpaste, and hairbrush.',
    exampleCn: '牙刷、牙膏和发刷都装进了手提箱。',
    tip: '💡 复合词拆解：suit (套装衣服) + case (盒子/箱子) = suitcase (装衣服的行李箱)！'
  },
  'toothbrush': {
    word: 'toothbrush',
    displayWord: 'toothbrush (牙刷)',
    phonetic: '/ˈtuːθbrʌʃ/',
    pos: 'n. 名词 (tooth + brush)',
    cn: '牙刷',
    en: 'A small brush with a long handle used for cleaning teeth. (tooth + brush)',
    emoji: '🪥',
    exampleEn: 'Don’t forget to pack your toothbrush.',
    exampleCn: '别忘了打包你的牙刷。',
    tip: '💡 复合词拆解：tooth (牙齿) + brush (刷子) = toothbrush (刷牙用的牙刷)！'
  },
  'toothpaste': {
    word: 'toothpaste',
    displayWord: 'toothpaste (牙膏)',
    phonetic: '/ˈtuːθpeɪst/',
    pos: 'n. 名词 (tooth + paste)',
    cn: '牙膏',
    en: 'A substance that you put on a toothbrush to clean your teeth. (tooth + paste)',
    emoji: '🦷',
    exampleEn: 'Squeeze a little toothpaste on the brush.',
    exampleCn: '在牙刷上挤一点牙膏。',
    tip: '💡 复合词拆解：tooth (牙齿) + paste (糊状物/膏) = toothpaste (清洁牙齿的膏体)！'
  },
  'hairbrush': {
    word: 'hairbrush',
    displayWord: 'hairbrush (发刷/梳子)',
    phonetic: '/ˈherbrʌʃ/',
    pos: 'n. 名词 (hair + brush)',
    cn: '发刷，毛刷，梳子',
    en: 'A brush used for smoothing and styling hair. (hair + brush)',
    emoji: '💇',
    exampleEn: 'She brushed her hair with a hairbrush.',
    exampleCn: '她用发刷梳理头发。',
    tip: '💡 复合词拆解：hair (头发) + brush (刷子) = hairbrush (梳理头发的刷子)！'
  },
  'swimsuit': {
    word: 'swimsuit',
    displayWord: 'swimsuit (泳衣)',
    phonetic: '/ˈswɪmsuːt/',
    pos: 'n. 名词 (swim + suit)',
    cn: '泳装，游泳衣',
    en: 'A piece of clothing worn for swimming. (swim + suit)',
    emoji: '🩱',
    exampleEn: 'Grammy told her to bring a swimsuit in case it was warm.',
    exampleCn: '奶奶让她带上泳衣，万一天气暖和可以游泳。',
    tip: '💡 复合词拆解：swim (游泳) + suit (服装/套装) = swimsuit (游泳时穿的衣服)！'
  },
  'storybooks': {
    word: 'storybooks',
    displayWord: 'storybooks (故事书复数)',
    phonetic: '/ˈstɔːribʊks/',
    pos: 'n. 名词复数 (story + books)',
    cn: '故事书（复数）',
    en: 'Books containing stories for children. (story + books)',
    emoji: '📚',
    exampleEn: 'Mom said to pack her favorite pillow and storybooks.',
    exampleCn: '妈妈说要带上她最喜欢的枕头和故事书。',
    tip: '💡 复合词拆解：story (故事) + books (书本复数) = storybooks (故事书)！'
  },
  'storybook': {
    word: 'storybook',
    displayWord: 'storybook (故事书单数)',
    phonetic: '/ˈstɔːribʊk/',
    pos: 'n. 名词 (story + book)',
    cn: '故事书，儿童画册',
    en: 'A book of stories for children.',
    emoji: '📖',
    exampleEn: 'She read a bedtime storybook.',
    exampleCn: '她读了一本睡前故事书。',
    tip: '💡 单数一个故事书用 a storybook，多个用 storybooks。'
  },
  'sunglasses': {
    word: 'sunglasses',
    displayWord: 'sunglasses (太阳镜/墨镜)',
    phonetic: '/ˈsʌnɡlæsɪz/',
    pos: 'n. 名词复数 (sun + glasses)',
    cn: '太阳镜，墨镜，防晒眼镜',
    en: 'Dark glasses that protect your eyes from bright sunlight. (sun + glasses)',
    emoji: '🕶️',
    exampleEn: 'Don’t forget to take Grammy’s sunglasses.',
    exampleCn: '别忘了带上奶奶的太阳镜。',
    tip: '💡 复合词拆解：sun (太阳) + glasses (眼镜) = sunglasses (遮挡太阳的墨镜)！通常用复数形式。'
  },
  'pajamas': {
    word: 'pajamas',
    displayWord: 'pajamas (睡衣裤)',
    phonetic: '/pəˈdʒɑːməz/',
    pos: 'n. 名词复数',
    cn: '睡衣，睡衣裤',
    en: 'Soft, loose clothing worn in bed for sleeping.',
    emoji: '👕',
    exampleEn: 'She will need to take her pajamas.',
    exampleCn: '她需要带上她的睡衣。',
    tip: '💡 美式拼写为 pajamas，英式拼写常为 pyjamas。睡衣通常成套出现，所以常用复数。'
  },
  'pillow': {
    word: 'pillow',
    displayWord: 'pillow (枕头)',
    phonetic: '/ˈpɪloʊ/',
    pos: 'n. 名词',
    cn: '枕头，软垫',
    en: 'A soft cushion used to rest your head upon when sleeping.',
    emoji: '🛏️',
    exampleEn: 'Mom said to pack her favorite pillow.',
    exampleCn: '妈妈说要带上她最喜欢的枕头。',
    tip: '💡 带着自己熟悉的软枕头去外婆家过夜，睡得格外香甜！'
  },
  'shirt': {
    word: 'shirt',
    displayWord: 'shirt (衬衫/短袖)',
    phonetic: '/ʃɜːrt/',
    pos: 'n. 名词',
    cn: '衬衫，短袖T恤',
    en: 'A garment for the upper body with collar or sleeves.',
    emoji: '👕',
    exampleEn: 'She took a shirt and some shorts.',
    exampleCn: '她带了一件衬衫和几条短裤。',
    tip: '💡 ir 组合发长卷舌音 /ɜːr/。'
  },
  'shorts': {
    word: 'shorts',
    displayWord: 'shorts (短裤)',
    phonetic: '/ʃɔːrts/',
    pos: 'n. 名词复数',
    cn: '短裤',
    en: 'Short pants ending above or at the knees.',
    emoji: '🩳',
    exampleEn: 'She packed some comfortable shorts.',
    exampleCn: '她打包了几条舒适的短裤。',
    tip: '💡 裤子有两个裤腿，所以总是用复数形式 shorts！'
  },
  'pack': {
    word: 'pack',
    displayWord: 'pack (打包/收拾行李)',
    phonetic: '/pæk/',
    pos: 'v. 动词 (过去式: packed)',
    cn: '打包，收拾（行李），装箱',
    en: 'To put clothes and belongings into a bag or suitcase.',
    emoji: '📦',
    exampleEn: 'Color the things that Kelly packed in her suitcase.',
    exampleCn: '给凯莉装进行李箱的物品涂上颜色。',
    tip: '💡 pack a suitcase 表示“收拾行李箱”。'
  },
  'packed': {
    word: 'packed',
    displayWord: 'packed (打包好的/装进箱子的)',
    phonetic: '/pækt/',
    pos: 'v. 过去式 / adj. 形容词',
    cn: '打包好了的，装箱的',
    en: 'Past tense of pack; put into a container.',
    emoji: '🧳',
    exampleEn: 'She packed her favorite storybooks.',
    exampleCn: '她打包好了自己最喜爱的故事书。',
    tip: '💡 -ed 发音为清辅音 /t/。'
  },
  'spend': {
    word: 'spend',
    displayWord: 'spend (度过/花费)',
    phonetic: '/spend/',
    pos: 'v. 动词',
    cn: '度过（时间）；花费（金钱）',
    en: 'To pass time in a specified way or place.',
    emoji: '⏳',
    exampleEn: 'Kelly is going to spend the night with her grandmother.',
    exampleCn: '凯莉打算在外婆家过夜。',
    tip: '💡 spend the night 是固定短语，表示“过夜/住一晚”。'
  },
  // === 1. 星期一：A Tiny Town 地底小镇秘密密码核心词汇 (Scholastic Developing Vocabulary) ===
  'prairie': {
    word: 'prairie',
